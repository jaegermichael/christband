  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#551839] via-[#3B1027] to-[#2F0B20]">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center px-4 py-20 text-center md:py-28">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg text-[#D8B9CB] leading-relaxed md:text-xl">
          Connecting the Body of Christ across Zimbabwe. Find churches, pastors, businesses, events, and a community united in faith.
        </p>

        {/* Search */}
        <form action="/churches" className="mt-8 flex w-full max-w-xl items-center rounded-2xl border border-[#D4AF37]/30 bg-[#FFFDF7]/10 p-1.5 backdrop-blur-sm">
        ...
        <div className="mt-12 grid grid-cols-2 gap-6 md:grid-cols-4">
          {[
            ...
            <div key={stat.label} className="text-center">
              ...
              <div className="mt-1 text-xs text-[#D8B9CB]">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
