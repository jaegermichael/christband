  ...
  return (
    <section className="py-16">
      <div className="mx-auto max-w-7xl px-4">
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-[#551839] via-[#3B1027] to-[#2F0B20] p-10 text-center md:p-16">
          <h2 className="font-serif text-3xl font-bold text-[#FFFDF7] md:text-4xl text-balance">
            Join the Christbrand Family Today
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-[#D8B9CB] leading-relaxed">
