    ...
    <section className="relative overflow-hidden bg-secondary px-4 py-16 text-secondary-foreground md:py-20">
      <div className="relative mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex shrink-0 flex-wrap gap-3">
          <Link href="/membership" className="inline-flex items-center gap-2 rounded-md bg-[#3A0353] px-5 py-3 text-sm font-bold text-white hover:-translate-y-0.5 hover:bg-[#4F1A74]">Join the community <ArrowUpRight className="h-4 w-4 text-secondary" aria-hidden="true" /></Link>
