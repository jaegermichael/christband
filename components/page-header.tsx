...
export function PageHeader({ title, description, badge }: PageHeaderProps) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#551839] via-[#3B1027] to-[#2F0B20] py-16 md:py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-[#D8B9CB] leading-relaxed">{description}</p>
      </div>
