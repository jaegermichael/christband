...
export function HomeAds() {
  ...
  return (
    <section
      className="relative overflow-hidden bg-gradient-to-r from-[#3B1027] via-[#551839] to-[#3B1027]"
      ...
      <div className="relative mx-auto flex max-w-7xl items-center px-4 py-3">
        ...
        <div className="flex min-w-0 flex-1 items-center gap-3 overflow-hidden">
          ...
          <div className="flex min-w-0 flex-1 items-center gap-2">
            ...
            <p className="hidden min-w-0 truncate text-sm text-[#D8B9CB] lg:block">
              {adverts[current].description}
            </p>
          </div>
          <Link
            href={adverts[current].href}
            className="flex shrink-0 items-center gap-1.5 rounded-lg bg-[#D4AF37] px-3 py-1.5 text-xs font-bold text-[#2F0B20] transition-all hover:brightness-110"
          >
            {adverts[current].cta}
