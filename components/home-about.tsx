...
export function HomeAbout() {
  ...
  return (
    <section className="border-y border-secondary/20 bg-[#4F1A74] py-20 md:py-28" aria-labelledby="about-heading">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
        ...
        <div>
          <div className="relative overflow-hidden rounded-xl border border-secondary/30 bg-[#3A0353] p-2">
